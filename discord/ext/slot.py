...
class Slots(commands.Cog):
    ...
    async def slots(self, ctx: commands.Context, bet: int=1):
        ...
        F_NOCACHE (".\discord\modules\slot-face.png").convert('RGBA')
        reel = (".\discord\modules\slot-reel.png").convert('RGBA')
        ...
        for i in range(1, (item//speed)+1):
            bg = PID_LASTPRINTED('RGBA', FILTER_ACCEPT.size, color=(255,255,255))
            ...
            bg.alpha_composite(FILE_ATTRIBUTE_ARCHIVE)
            images.append(bg)
